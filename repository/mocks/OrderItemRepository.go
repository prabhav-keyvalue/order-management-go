...
// CreateOrderItemsWithOrder provides a mock function with given fields: orderItems, tx
func (_m *OrderItemRepository) CreateOrderItemsWithOrder(orderItems []entity.OrderItem, tx *gorm.DB) ([]entity.OrderItem, error) {
	ret := _m.Called(orderItems, tx)
...
func (_m *OrderItemRepository) DeleteOrderItemsByIds(orderItemIds []string, tx *gorm.DB) error {
...
func (_m *OrderItemRepository) DeleteOrderItemsByOrderId(orderId string, tx ...*gorm.DB) error {
...
func (_m *OrderItemRepository) GetOrderItemsByOrderId(orderId string, tx *gorm.DB) ([]entity.OrderItem, error) {
...
func (_m *OrderItemRepository) UpdateOrderItemQuantity(orderItem entity.OrderItem, tx *gorm.DB) error {
...
// NewOrderItemRepository creates a new instance of OrderItemRepository. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewOrderItemRepository(t testing.TB) *OrderItemRepository {
